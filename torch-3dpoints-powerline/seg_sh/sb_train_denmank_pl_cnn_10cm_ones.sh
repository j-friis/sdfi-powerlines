...
model_name=ResUNet18 data=segmentation/den_pl_cnn_10cm_ones \
training.wandb.log=True training.wandb.project=NewDenmark-Seg-modified training.wandb.name=CNN_ResUNet18_10cm_ones \
